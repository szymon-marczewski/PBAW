{extends file=$conf->root_path|cat:'/assets/templates/main.tpl'}
...
<div class="navbar navbar-inverse navbar-fixed-top headroom" >
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="{$conf->app_url}/app/ctrl.php"><img src="{$conf->app_url}/assets/images/logo.png" alt="Progressus HTML5 template"></a>
                </div>
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav pull-right">
                        <li><a href="{$conf->app_url}/app/ctrl.php">Kalkulator</a></li>
	...
	<div class="container">
		...
		<div class="row">
			...
			<article class="col-sm-8 maincontent">
				...
				<h3>O co chodzi?</h3>
				<p><img src="{$conf->app_url}/assets/images/mac.jpg" alt="" class="img-rounded pull-right" width="300" >Dla wszystkich którzy chcą mieć wszystko wyłożone na tacy.</p>
                                ...
                                <img src="{$conf->app_url}/assets/images/2.jpg">
			</article>
			<!-- /Article -->
