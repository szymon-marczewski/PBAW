...
{block name=content}        
	<div class="container">
		<ol class="breadcrumb">
			<li><a href="credit_calc.php">Kalkulator</a></li>
		...
		<div class="row">
			...
			<article class="col-sm-8 maincontent">
				...
				<h3>O co chodzi?</h3>
				<p><img src="assets/images/mac.jpg" alt="" class="img-rounded pull-right" width="300" >Dla wszystkich którzy chcą mieć wszystko wyłożone na tacy.</p>
